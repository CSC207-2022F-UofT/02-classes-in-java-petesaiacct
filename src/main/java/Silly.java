...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param nameOne is the first part of the name of this Silly instance.
     * @param nameTwo is the second part of the name of this Silly instance.
     */
    public Silly(String nameOne, String nameTwo){ this.name = nameOne + nameTwo; }
